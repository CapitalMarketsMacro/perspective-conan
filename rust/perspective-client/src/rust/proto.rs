...
pub struct MakeTableData {
    #[prost(oneof = "make_table_data::Data", tags = "1, 2, 3, 4, 5, 6, 7")]
...
pub mod make_table_data {
    ...
    pub enum Data {
        ...
        #[prost(string, tag = "7")]
        FromNdjson(::prost::alloc::string::String),
    }
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Scalar {
    #[prost(oneof = "scalar::Scalar", tags = "1, 4, 6, 7")]
...
pub mod request {
    ...
    pub enum ClientReq {
        ...
        RemoveHostedTablesUpdateReq(super::RemoveHostedTablesUpdateReq),
        #[prost(message, tag = "5")]
        ...
        ViewToNdjsonStringReq(super::ViewToNdjsonStringReq),
...
pub mod response {
    ...
    pub enum ClientResp {
        ...
        #[prost(message, tag = "37")]
        RemoveHostedTablesUpdateResp(super::RemoveHostedTablesUpdateResp),
        #[prost(message, tag = "5")]
        ...
        #[prost(message, tag = "36")]
        ViewToNdjsonStringResp(super::ViewToNdjsonStringResp),
        #[prost(message, tag = "27")]
...
pub struct GetFeaturesResp {
    ...
    pub aggregates: ::std::collections::HashMap<
        u32,
        get_features_resp::AggregateOptions,
    >,
...
pub mod get_features_resp {
    ...
    pub struct AggregateOptions {
        #[prost(message, repeated, tag = "1")]
        pub aggregates: ::prost::alloc::vec::Vec<AggregateArgs>,
    }
    #[derive(serde::Serialize)]
    #[allow(clippy::derive_partial_eq_without_eq)]
    #[derive(Clone, PartialEq, ::prost::Message)]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RemoveHostedTablesUpdateReq {
    #[prost(uint32, tag = "1")]
    pub id: u32,
}
#[derive(serde::Serialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RemoveHostedTablesUpdateResp {}
/// `Table::size`
#[derive(serde::Serialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ViewToNdjsonStringReq {
    #[prost(message, optional, tag = "1")]
    pub viewport: ::core::option::Option<ViewPort>,
    #[prost(bool, optional, tag = "2")]
    pub id: ::core::option::Option<bool>,
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ViewToNdjsonStringResp {
    #[prost(string, tag = "1")]
    pub ndjson_string: ::prost::alloc::string::String,
}
#[derive(serde::Serialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct ViewGetMinMaxResp {
    #[prost(message, optional, tag = "1")]
    pub min: ::core::option::Option<Scalar>,
    #[prost(message, optional, tag = "2")]
    pub max: ::core::option::Option<Scalar>,
}
#[derive(serde::Serialize)]
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
impl StatusCode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            StatusCode::ViewNotFound => "VIEW_NOT_FOUND",
            StatusCode::TransportError => "TRANSPORT_ERROR",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "VIEW_NOT_FOUND" => Some(Self::ViewNotFound),
...
impl GroupRollupMode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            GroupRollupMode::Rollup => "ROLLUP",
            GroupRollupMode::Flat => "FLAT",
            GroupRollupMode::Total => "TOTAL",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
